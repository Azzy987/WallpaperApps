...
val keystorePropsFile = rootProject.file("s26ultra/keystore.properties")
...
android {
    namespace = "com.droidates.s26ultrawallpapers"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.droidates.s26ultrawallpapers"
        minSdk = 28
        targetSdk = 36
        versionCode = 5
        versionName = "1.5"
