...
val keystorePropsFile = rootProject.file("xiaomi17/keystore.properties")
...
android {
    namespace = "com.droidates.xiaomi17ultrawallpapers"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.droidates.xiaomi17ultrawallpapers"
        minSdk = 28
        targetSdk = 36
        versionCode = 4
        versionName = "1.4"
