...
val keystorePropsFile = rootProject.file("iphone18/keystore.properties")
...
android {
    namespace = "com.droidates.iphone18wallpapers"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.droidates.iphone18wallpapers"
        minSdk = 28
        targetSdk = 36
        versionCode = 3
        versionName = "2.1"
