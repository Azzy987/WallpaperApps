...
import com.droidates.wallpapers.core.model.User
...
class AuthViewModel @Inject constructor(
    ...
    private val adManager: com.droidates.wallpapers.core.utils.AdManager
) : ViewModel() {

    private val WEB_CLIENT_ID = com.droidates.wallpapers.core.config.AppConfig.GOOGLE_WEB_CLIENT_ID
    ...
    fun navigateToSettings(navigationState: com.droidates.wallpapers.core.navigation.NavigationState) {
    ...
    override fun onCleared() {
        ...
        try {
            ...
            Log.d(TAG, "AuthViewModel cleared, authStateListener removed successfully")
        } catch (e: Exception) {
            Log.e(TAG, "Error removing authStateListener in onCleared", e)
        }
    }
