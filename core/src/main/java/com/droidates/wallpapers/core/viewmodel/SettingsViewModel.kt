...
class SettingsViewModel @Inject constructor(
    ...
    private val favoritesRepository: com.droidates.wallpapers.core.data.repository.FavoritesRepository
) : ViewModel() {
    ...
    // App version info
    val appVersion = "${AppConfig.VERSION_NAME} (${AppConfig.VERSION_CODE})"
