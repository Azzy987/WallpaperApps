...
class NetworkUtils @Inject constructor(
    ...
    // Start optimistic until the first real connectivity check completes.
    // On cold launch, ConnectivityManager can briefly report no active network
    // even while Firebase/HTTP requests work a moment later.
