# Enhanced ProGuard Rules for OnePlus 7 Wallpapers - App Size Optimization
...
# Remove ALL logging from our app
-assumenosideeffects class com.droidates.s26ultrawallpapers.** {
    public static *** Log*(...);
    public *** log*(...);
    void Log*(...);
    *** log(...);
...
-assumenosideeffects class com.droidates.s26ultrawallpapers.BuildConfig {
...
-keep class com.droidates.s26ultrawallpapers.model.** { *; }
-keepclassmembers class com.droidates.s26ultrawallpapers.model.** {
    <fields>;
    <init>(...);
}
...
-keep class com.droidates.s26ultrawallpapers.data.local.** { *; }

# ViewModels
-keep class * extends androidx.lifecycle.ViewModel { *; }
-keep class com.droidates.s26ultrawallpapers.viewmodel.** { *; }
...
# ===== ADDITIONAL OPTIMIZATIONS FOR ONEPLUS 7 WALLPAPERS =====
