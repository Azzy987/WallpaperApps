...
object PolicyContent {
     ...
     */
    val privacyPolicy = """
Privacy Policy for OnePlus 7 Wallpapers

Effective Date: 09-09-2025

OnePlus 7 Wallpapers ("we", "our", or "us") respects your privacy. This Privacy Policy explains how your information is collected, used, and protected when you use our Android application OnePlus 7 Wallpapers.
...
READ_MEDIA_IMAGES / READ_MEDIA_VISUAL_USER_SELECTED (Android 13+ / 14+): To access and manage wallpapers on newer Android versions.
...
📑 Terms of Use – OnePlus 7 Wallpapers

Last updated: September 09, 2025

Welcome to OnePlus 7 Wallpapers, developed by Droidates. By downloading or using the app, you agree to the following Terms of Use. If you do not agree, please do not use the app.
...
OnePlus 7 Wallpapers uses open-source libraries and services including but not limited to:
...
We may update these Terms of Use from time to time. Changes will be posted on this page, and your continued use of the app implies agreement with the latest version.
     ...
     */
    val licensesAndCredits = """
        ## OnePlus 7 Wallpapers – Licenses & Credits

        ### Wallpapers

        OnePlus 7 Wallpapers provides a curated collection of high-quality wallpapers sourced from various platforms:

        #### Exclusive Wallpapers

        Some wallpapers in this app are **exclusively created by the developer** of OnePlus 7 Wallpapers. These are original works and are **not available anywhere else**. Redistribution or commercial use of these exclusive wallpapers is **strictly prohibited** without prior permission.
    ...
    val changelog = """
        ...
        - Added new exclusive wallpapers for OnePlus 7
