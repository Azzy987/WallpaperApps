...
class FavoritesManager @Inject constructor(
    ...
    private val prefs = context.getSharedPreferences(AppConfig.TABLE_FAVORITES, Context.MODE_PRIVATE)
    ...
    private fun migrateOldFavorites() {
        ...
        if (oldFavorites != null && oldFavorites.isNotEmpty()) {
            ...
            prefs.edit()
                .putStringSet(AppConfig.TABLE_FAVORITES, oldFavorites)
                .apply()
    ...
    fun toggleFavorite(wallpaperId: String): Boolean {
        ...
        prefs.edit()
            .putStringSet(AppConfig.TABLE_FAVORITES, currentFavorites)
            .apply()
    ...
    fun getFavorites(): Set<String> {
        return prefs.getStringSet(AppConfig.TABLE_FAVORITES, emptySet()) ?: emptySet()
    }
} 