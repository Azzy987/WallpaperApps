...
object AppConfig {
    ...
    // ── App Identity ──────────────────────────────────────────────────────
    const val APP_NAME = "OnePlus 7T Wallpapers"
    const val TOOLBAR_TITLE = "ONEPLUS 7T WALLPAPERS"
    const val DEVELOPER_NAME = "Droidates"
    const val SUPPORT_EMAIL = "droidates@gmail.com"

    // ── Firestore — Wallpaper Collections ────────────────────────────────
    // Same brand as OnePlus 7 — shares the same Firestore collections
    ...
    const val COLLECTION_BANNERS_SUB = "OnePlus7TBanners"

    // ── Firestore — Users ─────────────────────────────────────────────────
    const val COLLECTION_USERS = "Users"
    const val DOCUMENT_USERS_APP = "OnePlusWallpapers"
    const val COLLECTION_USERS_SUB = "OnePlus7TAndroidUsers"

    // ── Firestore — App Update ────────────────────────────────────────────
    const val COLLECTION_APP_UPDATE = "AppUpdate"
    const val DOCUMENT_APP_UPDATE = "oneplus7twallpapers"
    ...
    const val TABLE_FAVORITES = "oneplus7tfavorites"

    // ── SharedPreferences ─────────────────────────────────────────────────
    const val PREFS_NAME = "oneplus7t_wallpapers_prefs"

    // ── File System ───────────────────────────────────────────────────────
    const val DOWNLOAD_FOLDER_NAME = "OnePlus7TWallpapers"
    ...
    // ── AdMob ─────────────────────────────────────────────────────────────
    const val AD_INTERSTITIAL_ID = "ca-app-pub-6427410984085546/9067922805"
    const val AD_REWARDED_ID     = "ca-app-pub-6427410984085546/5917797356"
    const val AD_NATIVE_ID       = "ca-app-pub-6427410984085546/9324586449"

    // ── Google Play Billing ───────────────────────────────────────────────
    const val BILLING_LIFETIME_ID = "oneplus7t_lifetime"  // ✅ confirmed
