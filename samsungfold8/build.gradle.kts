...
val keystorePropsFile = rootProject.file("samsungfold8/keystore.properties")
...
android {
    namespace = "com.droidates.samsungfold8wallpapers"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.droidates.samsungfold8wallpapers"
        minSdk = 28
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
